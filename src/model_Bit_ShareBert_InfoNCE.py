...
def info_nce_loss(query_embeddings, pos_doc_embeddings, neg_doc_embeddings, batch_size, num_docs, i, temperature=0.5):
    ...
    neg_scores = torch.matmul(query_embeddings, neg_doc_embeddings.transpose(-1, -2)).squeeze(
        1)  # [batch_size, num_negatives]
    # 合并正样本和负样本的相似度
...
if __name__ == "__main__":
    ...
    torch.save(model.state_dict(), '../model/Bi_Topic_XMC_Lawformer_InfoNCE/pytorch_model.bin')
